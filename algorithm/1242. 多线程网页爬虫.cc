/*
 * @lc app=leetcode.cn id=1242 lang=cpp
 *
 * [1242] 多线程网页爬虫
 *
 * https://leetcode.cn/problems/web-crawler-multithreaded/description/
 *
 * concurrency
 * Medium (48.37%)
 * Likes:    42
...
class Solution {
public:
    std::vector<std::string> crawl(std::string start_url, HtmlParser htmlParser) {
